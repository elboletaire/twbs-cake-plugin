...
$is_add  = strpos($action, 'add') !== false;
$is_edit = !$is_add;
...
<div class="actions columns col-md-2 col-sm-3">
	...
	<ul class="nav nav-pills nav-stacked">
		<li<?php if ($is_add) echo ' class="active"' ?>><?= "<?= \$this->Html->link(__('New " . $singularHumanName . "'), ['action' => 'add']) ?>"; ?></li>
<?php if ($is_edit): ?>
...
<div class="<?= $pluralVar ?> form col-md-10 col-sm-9">
