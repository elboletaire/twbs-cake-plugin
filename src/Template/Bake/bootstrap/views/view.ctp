...
<div class="<?= $pluralVar ?> view col-md-10 col-sm-9">
...
<?php if ($groupedFields['number']) : ?>
		<div class="col-lg-2 col-lg-offset-1 columns numbers end">
	...
	<div class="table-responsive">
		...
		echo "\t\t<?php foreach (\${$singularVar}->{$details['property']} as \${$otherSingularVar}): ?>\n";
			echo "\t\t<tr>\n";
				...
				echo "\t\t\t\t<?= \$this->Html->link('<span class=\"glyphicon glyphicon-zoom-in\"></span>', ['controller' => '{$details['controller']}', 'action' => 'view', {$otherPk}], ['escape' => false, 'class' => 'btn btn-xs btn-default', 'title' => __('View')]) ?>\n";
				echo "\t\t\t\t<?= \$this->Html->link('<span class=\"glyphicon glyphicon-pencil\"></span>', ['controller' => '{$details['controller']}', 'action' => 'edit', {$otherPk}], ['escape' => false, 'class' => 'btn btn-xs btn-default', 'title' => __('Edit')]) ?>\n";
				echo "\t\t\t\t<?= \$this->Form->postLink('<span class=\"glyphicon glyphicon-trash\"></span>', ['controller' => '{$details['controller']}', 'action' => 'delete', {$otherPk}], ['confirm' => __('Are you sure you want to delete # %s?', {$otherPk}), 'escape' => false, 'class' => 'btn btn-xs btn-danger', 'title' => __('Delete')]) ?>\n";
				echo "\t\t\t</td>\n";
			echo "\t\t</tr>\n";
